...
const EnquiryForm = () => {
  ...
  const stepLabels = ["About You", "Journey", "Locations", "Date & Time", "Extras"];

  if (submitted) {
    return (
      <section id="enquiry" className="bg-navy py-20 lg:py-28">
  ...
  return (
    <section id="enquiry" className="bg-navy py-20 lg:py-28">
      <div className="mx-auto max-w-2xl px-6">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          {stepLabels.map((label, i) => (
            <div key={i} className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline text-xs text-primary-foreground/60">{label}</span>
        ...
        <div className="rounded-xl bg-navy-light/40 border border-navy-light/30 p-8">
          {/* Step 1: About You */}
          {step === 1 && (
            <div className="space-y-5">
              <div>
                <h3 className="font-serif text-lg font-bold text-primary-foreground">Your Details</h3>
                <p className="text-sm text-primary-foreground/60 mt-1">So we know who to send the quote to.</p>
              </div>
              <div>
