...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="bg-navy py-20 lg:py-28">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-3">
          {steps.map((step) => (
            <div key={step.number} className="text-center">
              <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-gold/20 text-2xl font-bold text-gold">
                {step.number}
              </div>
